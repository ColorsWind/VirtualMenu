...
public abstract class AbstractPacketMenu implements IPacketMenu, ConfSerializable<StandardConf> {
	...
	@Getter
	protected final UpdatePeriod updateDelay;
	...
	public AbstractPacketMenu(UpdatePeriod updateDelay, String title, IMenuType type) {
		this(updateDelay, title, type, new Icon[type.getSize()], new EnumMap<>(EventType.class));
	}

	public AbstractPacketMenu(UpdatePeriod updateDelay, String title, IMenuType type, Icon[] icons,
