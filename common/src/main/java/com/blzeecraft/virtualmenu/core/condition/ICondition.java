...
public interface ICondition
		extends Function<MenuEvent, Optional<String>>, Predicate<MenuEvent>, IScope {

	/**
	 * 检查事件是否满足条件, 这个方法通常会在检查view-condition时被调用.
	 * <p>
	...
	/**
	 * 检查事件是否满足条件, 这个方法通常会在检查click-condition时被调用.
	 * 
	 * 
	 * @param event 待测事件
	 * @return {@link Optional#empty()} 如果满足条件, 否则返回非空 {@link Optional}, 这种情况下可用
	 *         {@link Optional#get()} 获取不满足条件的原因.
	 */
	@Override
